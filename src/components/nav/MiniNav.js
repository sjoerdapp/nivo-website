    ...
    render () {
        ...
        return (
            <aside className="mini-nav">
                <Link
                    className="mini-nav_item mini-nav_item-nivo"
                    to="/"
                >
                    <span className="mini-nav_item_icon" />
                </Link>
                        ...
                        <div>
                            {interpolatedStyles.map(item => {
                                const style = {
                                    ...
                                    transform: `translate3d(0,${item.style.top}px,0)`,
                                    zIndex:    item.style.zIndex
                                };

                                if (item.data.path) {
                                    return <MiniNavLink style={style} {...item.data} />;
                                }

                                return (
                                    <span onClick={this.closeChildren} className="mini-nav_item mini-nav_item-back" style={style}>
                                        <span className="mini-nav_item_icon" />
                                    </span>
                                );
                            })}
